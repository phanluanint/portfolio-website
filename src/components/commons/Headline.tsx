...
const Headline: React.FC = ({ children }) => {
  return (
    <div className="relative mb-16 mt-16 md:mt-32">
      ...
      <div className="text-6xl md:text-7xl absolute top-0 left-0 uppercase font-black opacity-3 mt-6 whitespace-no-wrap overflow-hidden">
        {children}
      </div>
    </div>
  )
